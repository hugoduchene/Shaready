...
class LikeArticle(models.Model):
    ...
    id_user = models.ForeignKey(CustomUser, on_delete=models.CASCADE)
    reaction = models.CharField(max_length=40, choices=LikeChoicesArticles, default="")
...
class LikeComment(models.Model):
    ...
    id_user = models.ForeignKey(CustomUser, on_delete=models.CASCADE)
    reaction_comment = models.CharField(max_length=40, choices=LikeChoicesComment, default="")
